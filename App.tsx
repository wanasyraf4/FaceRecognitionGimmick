...
const App: React.FC = () => {
  return (
    <div className="min-h-screen bg-slate-900 text-cyan-400 flex flex-col items-center justify-center p-4">
      <header className="absolute top-0 left-0 right-0 p-4 md:p-6 bg-slate-900/50 backdrop-blur-sm border-b border-cyan-500/20">
      ...
      <footer className="absolute bottom-0 left-0 right-0 p-3 text-center text-xs text-cyan-700">
